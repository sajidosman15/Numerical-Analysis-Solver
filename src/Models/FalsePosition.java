...
public class FalsePosition extends Method{
    private String xl;
    private String xu;
    private String xr;
    private String xrold="-99999";

    public FalsePosition(String function, String xl, String xu) {
        super(function);
        this.xl=xl;
        this.xu=xu;
    }
    ...
    public String getXR(){
        System.out.println("\n           "+negativeCheck(getFofFalse(negativeCheck(xu)))+" * ("+negativeCheck(xl)+" - "+negativeCheck(xu)+")");
        System.out.println("=> "+xu+" - ---------------------------");
        System.out.println("                 "+negativeCheck(getFofFalse(negativeCheck(xl)))+" - "+negativeCheck(getFofFalse(negativeCheck(xu))));
        
        
        String text=negativeCheck(xu)+"-(("+negativeCheck(getFofFalse(negativeCheck(xu)))+"×("+negativeCheck(xl)+"-"+negativeCheck(xu)+"))/("+negativeCheck(getFofFalse(negativeCheck(xl)))+"-"+negativeCheck(getFofFalse(negativeCheck(xu)))+"))";
